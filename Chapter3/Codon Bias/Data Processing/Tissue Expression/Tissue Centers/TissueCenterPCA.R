library(factoextra)
enriched <- read.csv(file.choose(), header = FALSE, row.names = 1)
...
enhanced <- read.csv(file.choose(), header = FALSE, row.names = 1)
...
elevated <- read.csv(file.choose(), header = FALSE, row.names = 1)
